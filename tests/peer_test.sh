...
function peer_test() {
  ...
  bash create_subscription.sh $env1 $admin1 $name2 PB FL "CP,CL,DS,DT,PR,RG" 60 $cert1 $key1
  bash create_subscription.sh $env2 $admin2 $name1 PB FL "CP,CL,DS,DT,PR,RG" 60 $cert2 $key2
}
