...
export ACUMOS_HTTP_PROXY="${ACUMOS_HTTP_PROXY:-}"
export ACUMOS_HTTPS_PROXY="${ACUMOS_HTTPS_PROXY:-}"
...
export ACUMOS_ELASTICSEARCH_DATA_PV_CLASSNAME="${ACUMOS_ELASTICSEARCH_DATA_PV_CLASSNAME:-$ACUMOS_10GI_STORAGECLASSNAME}"
...
export ACUMOS_ELASTICSEARCH_DATA_PV_CLASSNAME=$ACUMOS_ELASTICSEARCH_DATA_PV_CLASSNAME
EOF
