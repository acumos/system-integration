...
# $ bash setup_jupyterhub.sh <setup|clean|all> <NAMESPACE> <K8S_INGRESS_ORIGIN>
...
function setup_jenkins() {
  ...
  sedi "s/<NAMESPACE>/$NAMESPACE/g" values.yaml
  sedi "s/<K8S_INGRESS_DOMAIN>/$K8S_INGRESS_DOMAIN/g" values.yaml
  sedi "s/<HOST_IP>/$HOST_IP/g" values.yaml
