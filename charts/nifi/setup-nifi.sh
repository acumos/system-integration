...
# - Make sure there are at least 6 free PVs for nifi, e.g. by these commands
#   run by the cluster admin. "standard" is the required storage class. Use
#   values per your environment for parameter 2-5 below.
#   bash system-integration/tools/setup-pv.sh setup opnfv06 ubuntu nifi-01 /mnt 10Gi standard
#   bash system-integration/tools/setup-pv.sh setup opnfv06 ubuntu nifi-02 /mnt 10Gi standard
#   bash system-integration/tools/setup-pv.sh setup opnfv06 ubuntu nifi-03 /mnt 10Gi standard
#   bash system-integration/tools/setup-pv.sh setup opnfv06 ubuntu nifi-04 /mnt 10Gi standard
#   bash system-integration/tools/setup-pv.sh setup opnfv06 ubuntu nifi-05 /mnt 10Gi standard
#   bash system-integration/tools/setup-pv.sh setup opnfv06 ubuntu nifi-06 /mnt 10Gi standard
#
#
# Usage:
