...
# Sets in /conf/authorizers.xml
#   - userGroupProvider
#     - Initial User Identity 1 = OpenId ID
#   - accessPolicyProvider
#     - Initial Admin Identity = OpenId ID
# If present, removes /conf/authorizations.xml, /conf/users.xml
#
# NiFi registry 0.3.0
