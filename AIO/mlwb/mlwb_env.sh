...
export MLWB_PROJECT_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/project-catalog-webcomponent:2.0.6
export MLWB_NOTEBOOK_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/notebook-catalog-webcomponent:2.0.6
export MLWB_PIPELINE_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/pipeline-catalog-webcomponent:2.0.6
