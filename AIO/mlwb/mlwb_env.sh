...
export MLWB_DASHBOARD_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/dashboard-webcomponent:2.0.6
export MLWB_PROJECT_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/project-webcomponent:2.0.6
export MLWB_NOTEBOOK_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/notebook-webcomponent:2.0.6
export MLWB_PIPELINE_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/pipeline-webcomponent:2.0.6
export MLWB_PROJECT_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/project-catalog-webcomponent:2.0.7
export MLWB_NOTEBOOK_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/notebook-catalog-webcomponent:2.0.7
export MLWB_PIPELINE_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/pipeline-catalog-webcomponent:2.0.7
...
export ACUMOS_MLWB_LOGS_PVC_NAME=$ACUMOS_LOGS_PVC_NAME
export ACUMOS_MLWB_LOGS_PV_NAME=$ACUMOS_LOGS_PV_NAME
