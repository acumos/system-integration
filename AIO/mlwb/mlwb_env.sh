...
export MLWB_HOME_WEBCOMPONENT_IMAGE=$ACUMOS_RELEASE/home-webcomponent:1.0.5
export MLWB_DASHBOARD_WEBCOMPONENT_IMAGE=$ACUMOS_RELEASE/dashboard-webcomponent:1.0.5
export MLWB_PROJECT_WEBCOMPONENT_IMAGE=$ACUMOS_RELEASE/project-webcomponent:1.0.5
export MLWB_NOTEBOOK_WEBCOMPONENT_IMAGE=$ACUMOS_RELEASE/notebook-webcomponent:1.0.5
export MLWB_PIPELINE_WEBCOMPONENT_IMAGE=$ACUMOS_SNAPSHOT/pipeline-webcomponent:1.0.5-SNAPSHOT
export MLWB_PROJECT_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_RELEASE/project-catalog-webcomponent:1.0.5
export MLWB_NOTEBOOK_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_RELEASE/notebook-catalog-webcomponent:1.0.5
