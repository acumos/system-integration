...
export MLWB_PIPELINE_SERVICE_IMAGE=pipeline-service:1.0.1-SNAPSHOT
export MLWB_HOME_WEBCOMPONENT_IMAGE=$ACUMOS_SNAPSHOT/home-webcomponent:1.0.4-SNAPSHOT
export MLWB_DASHBOARD_WEBCOMPONENT_IMAGE=$ACUMOS_SNAPSHOT/dashboard-webcomponent:1.0.3-SNAPSHOT
export MLWB_PROJECT_WEBCOMPONENT_IMAGE=$ACUMOS_SNAPSHOT/project-webcomponent:1.0.3-SNAPSHOT
export MLWB_NOTEBOOK_WEBCOMPONENT_IMAGE=$ACUMOS_SNAPSHOT/notebook-webcomponent:1.0.3-SNAPSHOT
export MLWB_PIPELINE_WEBCOMPONENT_IMAGE=$ACUMOS_SNAPSHOT/pipeline-webcomponent:1.0.3-SNAPSHOT
export MLWB_PROJECT_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_SNAPSHOT/project-catalog-webcomponent:1.0.3-SNAPSHOT
export MLWB_NOTEBOOK_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_SNAPSHOT/notebook-catalog-webcomponent:1.0.3-SNAPSHOT
export MLWB_PIPELINE_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_SNAPSHOT/pipeline-catalog-webcomponent:1.0.3-SNAPSHOT
...
export MLWB_NIFI_REGISTRY_INITIAL_ADMIN="admin"
