...
export MLWB_PROJECT_SERVICE_IMAGE=$ACUMOS_STAGING/project-service:1.0.2
export MLWB_NOTEBOOK_SERVICE_IMAGE=$ACUMOS_STAGING/notebook-service:1.0.2
export MLWB_PIPELINE_SERVICE_IMAGE=$ACUMOS_STAGING/pipeline-service:1.0.2
export MLWB_MODEL_SERVICE_IMAGE=$ACUMOS_STAGING/model-service:1.0.0
export MLWB_HOME_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/home-webcomponent:1.0.6
export MLWB_DASHBOARD_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/dashboard-webcomponent:1.0.6
export MLWB_PROJECT_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/project-webcomponent:1.0.6
export MLWB_NOTEBOOK_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/notebook-webcomponent:1.0.6
export MLWB_PIPELINE_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/pipeline-webcomponent:1.0.6
export MLWB_PROJECT_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/project-catalog-webcomponent:1.0.6
export MLWB_NOTEBOOK_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/notebook-catalog-webcomponent:1.0.6
export MLWB_PIPELINE_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/pipeline-catalog-webcomponent:1.0.6
