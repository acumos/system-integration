...
export MLWB_PROJECT_SERVICE_IMAGE=$ACUMOS_STAGING/project-service:2.0.0
export MLWB_NOTEBOOK_SERVICE_IMAGE=$ACUMOS_STAGING/notebook-service:2.0.0
export MLWB_PIPELINE_SERVICE_IMAGE=$ACUMOS_STAGING/pipeline-service:2.0.0
export MLWB_MODEL_SERVICE_IMAGE=$ACUMOS_STAGING/model-service:2.0.0
export MLWB_HOME_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/home-webcomponent:2.0.0
export MLWB_DASHBOARD_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/dashboard-webcomponent:2.0.0
export MLWB_PROJECT_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/project-webcomponent:2.0.0
export MLWB_NOTEBOOK_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/notebook-webcomponent:2.0.0
export MLWB_PIPELINE_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/pipeline-webcomponent:2.0.0
export MLWB_PROJECT_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/project-catalog-webcomponent:2.0.0
export MLWB_NOTEBOOK_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/notebook-catalog-webcomponent:2.0.0
export MLWB_PIPELINE_CATALOG_WEBCOMPONENT_IMAGE=$ACUMOS_STAGING/acumos/pipeline-catalog-webcomponent:2.0.0
