...
export ACUMOS_NEXUS_HOST="${ACUMOS_NEXUS_HOST:-nexus-service}"
export ACUMOS_DOCKER_REGISTRY_DOMAIN=$ACUMOS_NEXUS_DOMAIN
export ACUMOS_DOCKER_REGISTRY_HOST=$ACUMOS_NEXUS_HOST

export ACUMOS_NEXUS_DEPLOYMENT="${ACUMOS_NEXUS_DEPLOYMENT:-internal}"
export ACUMOS_NEXUS_NAMESPACE="${ACUMOS_NEXUS_NAMESPACE:-$ACUMOS_NAMESPACE}"
