...
export ACUMOS_INTERNAL_NEXUS_HOST="${ACUMOS_INTERNAL_NEXUS_HOST:-nexus-service.$ACUMOS_NEXUS_NAMESPACE.svc.cluster.local}"
export ACUMOS_NEXUS_HOST="${ACUMOS_NEXUS_HOST:-$ACUMOS_INTERNAL_NEXUS_HOST}"
export ACUMOS_DOCKER_REGISTRY_DOMAIN=$ACUMOS_NEXUS_DOMAIN
...
export ACUMOS_NEXUS_API_NODEPORT="${ACUMOS_NEXUS_API_NODEPORT:-}"
...
export ACUMOS_DOCKER_MODEL_NODEPORT="${ACUMOS_DOCKER_MODEL_NODEPORT:-}"
...
export ACUMOS_DOCKER_REGISTRY_DOMAIN=$ACUMOS_DOCKER_REGISTRY_DOMAIN
