...
#   $ bash peer_test.sh <env1> <admin1> <env2> <admin2>
...
function peer_test() {
  ...
  bash create_subscription.sh $env1 $admin1 $name2 PB FL 1 "CL,DS,DT,PR,RG"
  bash create_subscription.sh $env2 $admin2 $name1 PB FL 1 "CL,DS,DT,PR,RG"
}
