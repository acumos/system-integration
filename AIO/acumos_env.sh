...
export PORTAL_BE_IMAGE=$ACUMOS_STAGING/acumos-portal-be:3.0.19
export PORTAL_FE_IMAGE=$ACUMOS_STAGING/acumos-portal-fe:3.0.19
export LICENSE_PROFILE_EDITOR_IMAGE=$ACUMOS_RELEASE/acumos/license-profile-editor:0.0.7
export LICENSE_RTU_EDITOR_IMAGE=$ACUMOS_RELEASE/acumos/license-rtu-editor:0.1.1
