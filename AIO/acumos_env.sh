...
export SECURITY_VERIFICATION_IMAGE=$ACUMOS_STAGING/security-verification:0.0.21
...
export BLUEPRINT_ORCHESTRATOR_IMAGE=$ACUMOS_STAGING/blueprint-orchestrator:2.0.13
