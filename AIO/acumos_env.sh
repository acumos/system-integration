...
export PORTAL_BE_IMAGE=$ACUMOS_STAGING/acumos-portal-be:2.2.14
export PORTAL_FE_IMAGE=$ACUMOS_STAGING/acumos-portal-fe:2.2.14
...
export SECURITY_VERIFICATION_IMAGE=$ACUMOS_SNAPSHOT/security-verification:0.0.20-SNAPSHOT
