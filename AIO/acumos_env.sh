...
export PORTAL_BE_IMAGE=$ACUMOS_SNAPSHOT/acumos-portal-be:2.2.17-SNAPSHOT
export PORTAL_FE_IMAGE=$ACUMOS_SNAPSHOT/acumos-portal-fe:2.2.17-SNAPSHOT
...
export MICROSERVICE_GENERATION_IMAGE=$ACUMOS_RELEASE/microservice-generation:2.12.0
export ONBOARDING_IMAGE=$ACUMOS_RELEASE/onboarding-app:2.14.0
export SECURITY_VERIFICATION_IMAGE=$ACUMOS_SNAPSHOT/security-verification:0.0.23-SNAPSHOT
...
export K8S_DIST=
export AIO_ROOT=/home/bryan/Dropbox/git/acumos/system-integration/AIO
...
export ACUMOS_MICROSERVICE_GENERATION_ASYNC=true
export ACUMOS_OPERATOR_ID=12345678-abcd-90ab-cdef-1234567890ab
export ACUMOS_PORTAL_PUBLISH_SELF_REQUEST_ENABLED=false
export ACUMOS_PORTAL_ENABLE_PUBLICATION=false
