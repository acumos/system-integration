...
export LICENSE_PROFILE_EDITOR_IMAGE=$ACUMOS_STAGING/license-profile-editor:0.0.6
export LICENSE_RTU_EDITOR_IMAGE=$ACUMOS_STAGING/license-rtu-editor:0.0.6
export COMMON_DATASERVICE_IMAGE=$ACUMOS_STAGING/common-dataservice:3.0.0
...
export SECURITY_VERIFICATION_IMAGE=$ACUMOS_RELEASE/acumos/security-verification:1.2.0
