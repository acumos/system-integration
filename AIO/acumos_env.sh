...
export PORTAL_BE_IMAGE=$ACUMOS_STAGING/acumos-portal-be:2.2.13
export PORTAL_FE_IMAGE=$ACUMOS_STAGING/acumos-portal-fe:2.2.13
export COMMON_DATASERVICE_IMAGE=$ACUMOS_STAGING/common-dataservice:2.2.3
