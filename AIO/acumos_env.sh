...
export PORTAL_BE_IMAGE=$ACUMOS_SNAPSHOT/acumos-portal-be:3.0.5-SNAPSHOT
export PORTAL_FE_IMAGE=$ACUMOS_SNAPSHOT/acumos-portal-fe:3.0.5-SNAPSHOT
...
export MICROSERVICE_GENERATION_IMAGE=$ACUMOS_STAGING/microservice-generation:2.14.0
