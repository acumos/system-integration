...
# https://wiki.acumos.org/display/REL/Weekly+Assembly+Acumos_1903232100
# Core components
export AZURE_CLIENT_IMAGE=$ACUMOS_STAGING/acumos-azure-client:2.0.8
export PORTAL_CMS_IMAGE=$ACUMOS_RELEASE/acumos-cms-docker:1.3.5
export PORTAL_BE_IMAGE=$ACUMOS_STAGING/acumos-portal-be:2.2.6
export PORTAL_FE_IMAGE=$ACUMOS_STAGING/acumos-portal-fe:2.2.6
...
export MICROSERVICE_GENERATION_IMAGE=$ACUMOS_STAGING/microservice-generation:2.7.0
export ONBOARDING_IMAGE=$ACUMOS_STAGING/onboarding-app:2.9.0
export SECURITY_VERIFICATION_IMAGE=$ACUMOS_SNAPSHOT/security-verification:0.0.3-SNAPSHOT
