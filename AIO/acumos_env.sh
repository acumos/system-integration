...
export PORTAL_BE_IMAGE=$ACUMOS_STAGING/acumos-portal-be:2.2.17
export PORTAL_FE_IMAGE=$ACUMOS_STAGING/acumos-portal-fe:2.2.17
...
export SECURITY_VERIFICATION_IMAGE=$ACUMOS_RELEASE/security-verification:0.0.21
