...
# https://wiki.acumos.org/display/REL/Acumos_Clio_Release
...
export PORTAL_BE_IMAGE=$ACUMOS_RELEASE/acumos-portal-be:3.0.20
export PORTAL_FE_IMAGE=$ACUMOS_RELEASE/acumos-portal-fe:3.0.20
...
export SECURITY_VERIFICATION_IMAGE=$ACUMOS_RELEASE/acumos/security-verification:1.2.1
export OPENSTACK_CLIENT_IMAGE=$ACUMOS_RELEASE/openstack-client:3.0.0
export DEPLOYMENT_CLIENT_IMAGE=$ACUMOS_RELEASE/deployment-client:1.0.1
