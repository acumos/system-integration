...
#   user: account to use for setting up host-based persistent volumes. For k8s
#     based platforms, this should be the username of the sudo-enabled user that
#     is running this script; for docker, the username of the user that will be
#     deploying the platform (to be added to the docker group).
...
# If running this for yourself, you need to have previously added your account
# to the docker group
