...
if [[ "$ACUMOS_HOST_USER" != "$USER" ]]; then
  ...
  sudo mkdir /home/$ACUMOS_HOST_USER/acumos/env/clean/
  sudo cp /home/$ACUMOS_HOST_USER/env/* /home/$ACUMOS_HOST_USER/acumos/env/clean/.
  sudo chown -R $ACUMOS_HOST_USER:$ACUMOS_HOST_USER /home/$ACUMOS_HOST_USER/acumos/env/clean
fi
