...
function setup_acumos() {
  ...
  #  create_image_pull_secret VALIDATION_ENGINE_IMAGE validation-engine
    ...
    depvars="ACUMOS_MARIADB_HOST ACUMOS_MARIADB_PORT MARIADB_USER_PASSWORD ACUMOS_NEXUS_API_PORT ACUMOS_NEXUS_HOST ACUMOS_RW_USER_PASSWORD ACUMOS_DOCKER_API_HOST ACUMOS_DOCKER_MODEL_PORT ACUMOS_DOCKER_PLATFORM_PORT"
