...
export COMMON_DATASERVICE_IMAGE=$RELEASE/common-dataservice:1.14.4
export ONBOARDING_IMAGE=$STAGING/onboarding-app:1.24.0
export PORTAL_BE_IMAGE=$STAGING/acumos-portal-be:1.15.23
export PORTAL_FE_IMAGE=$STAGING/acumos-portal-fe:1.15.23
export PORTAL_CMS_IMAGE=$STAGING/acumos-cms-docker:1.3.3
export DESIGNSTUDIO_IMAGE=$STAGING/ds-compositionengine:0.0.29
...
export ACUMOS_DOCKER_API_PORT=4243
...
export ACUMOS_ONBOARDING_PORT=30890
...
export ACUMOS_PORTAL_FE_PORT=30885
