...
# Core components
export AZURE_CLIENT_IMAGE=$ACUMOS_STAGING/acumos-azure-client:2.0.10
export PORTAL_CMS_IMAGE=$ACUMOS_RELEASE/acumos-cms-docker:1.3.5
export PORTAL_BE_IMAGE=$ACUMOS_STAGING/acumos-portal-be:2.2.5
export PORTAL_FE_IMAGE=$ACUMOS_STAGING/acumos-portal-fe:2.2.5
export COMMON_DATASERVICE_IMAGE=$ACUMOS_STAGING/common-dataservice:2.2.0
export DESIGNSTUDIO_IMAGE=$ACUMOS_STAGING/ds-compositionengine:2.0.6
export FEDERATION_IMAGE=$ACUMOS_STAGING/federation-gateway:2.1.1
export KUBERNETES_CLIENT_IMAGE=$ACUMOS_STAGING/kubernetes-client:2.0.4
export MICROSERVICE_GENERATION_IMAGE=$ACUMOS_STAGING/microservice-generation:2.6.0
export ONBOARDING_IMAGE=$ACUMOS_STAGING/onboarding-app:2.7.0
export OPENSTACK_CLIENT_IMAGE=$ACUMOS_STAGING/openstack-client:2.0.8
...
export BLUEPRINT_ORCHESTRATOR_IMAGE=$ACUMOS_STAGING/blueprint-orchestrator:2.0.11
...
export ACUMOS_DOCKER_API_HOST=$ACUMOS_HOST
...
export ACUMOS_KONG_ADMIN_HOST=$ACUMOS_HOST
