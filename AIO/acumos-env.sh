...
export ACUMOS_CDS_HOSTNAME=cds.$ACUMOS_DOMAIN
export ACUMOS_CDS_PORT=8000
export ACUMOS_NEXUS_HOST=$host
export ACUMOS_NEXUS_HOSTNAME=nexus.$ACUMOS_DOMAIN
export ACUMOS_MAVEN_MODEL_PORT=8001
export ACUMOS_MAVEN_MODEL_REPO=maven.model.$ACUMOS_DOMAIN
export ACUMOS_DOCKER_MODEL_PORT=8002
export ACUMOS_DOCKER_MODEL_REPO=docker.model.$ACUMOS_DOMAIN
export ACUMOS_DOCKER_PLATFORM_PORT=8003
export ACUMOS_DOCKER_PLATFORM_REPO=docker.platform.$ACUMOS_DOMAIN
...
export ACUMOS_PORTAL_FE_HOSTNAME=portal.$ACUMOS_DOMAIN
