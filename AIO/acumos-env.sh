...
export ACUMOS_CA_CERT=$ACUMOS_DOMAIN-ca.crt
export ACUMOS_CERT=$ACUMOS_DOMAIN.crt
export ACUMOS_CERT_KEY=$ACUMOS_DOMAIN.key
export ACUMOS_CERT_KEY_PASSWORD=
export ACUMOS_KEYSTORE=$ACUMOS_DOMAIN-keystore.p12
export ACUMOS_KEYSTORE_PASSWORD=
export ACUMOS_TRUSTSTORE=$ACUMOS_DOMAIN-truststore.jks
