...
if [[ "$action" == "compare" ]]; then
  compare_env $old/AIO/acumos_env.sh $new/AIO/acumos_env.sh
  compare_env $old/AIO/mlwb/mlwb_env.sh $new/AIO/mlwb/mlwb_env.sh
elif [[ "$action" == "update" ]]; then
  update_env $old/AIO/acumos_env.sh $new/AIO/acumos_env.sh
  compare_env $old/AIO/acumos_env.sh $new/AIO/acumos_env.sh
  update_env $old/AIO/mlwb/mlwb_env.sh $new/AIO/mlwb/mlwb_env.sh
  compare_env $old/AIO/mlwb/mlwb_env.sh $new/AIO/mlwb/mlwb_env.sh
