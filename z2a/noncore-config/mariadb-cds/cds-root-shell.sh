...
# ===============LICENSE_END=========================================================
#
# Name: cds-root-shell.sh - CDS helper script
...
kubectl run $RELEASE-client --rm --tty -i --restart='Never' --image  docker.io/bitnami/mariadb:latest --namespace $NAMESPACE --command -- mysql -h $RELEASE.$NAMESPACE.svc.cluster.local -uroot -p$ROOT_PASSWORD
