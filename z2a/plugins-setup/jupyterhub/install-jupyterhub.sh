...
log "$(kubectl --namespace=$MLWB_NAMESPACE get pod)"

log "Retrieving JupyterHub Public IP Address ...."
log "$(kubectl --namespace=$MLWB_NAMESPACE get svc proxy-public)"
...
log "JupyterHub proxy and hub secret tokens are contained in $HERE/jhub_value.yaml file."
