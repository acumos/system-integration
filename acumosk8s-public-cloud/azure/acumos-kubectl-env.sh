...
# Images
export ACUMOS_ONBOARDING_IMAGE=onboarding-app:1.27.0
export ACUMOS_PORTAL_BE_IMAGE=acumos-portal-be:1.15.33
export ACUMOS_PORTAL_FE_IMAGE=acumos-portal-fe:1.15.33
...
export ACUMOS_CDS_IMAGE=common-dataservice:1.14.4
...
export ACUMOS_AZURE_CLIENT_IMAGE=acumos-azure-client:1.2.4
...
export ACUMOS_OPENSTACK=openstack-client:1.41.0
