...
export ACUMOS_PORTAL_BE_IMAGE=acumos-portal-be:1.15.32
export ACUMOS_PORTAL_FE_IMAGE=acumos-portal-fe:1.15.32
export ACUMOS_CMS_IMAGE=acumos-cms-docker:1.3.4
export ACUMOS_DESIGN_STUDIO_IMAGE=ds-compositionengine:0.0.31
